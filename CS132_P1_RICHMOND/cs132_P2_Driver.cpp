...
//				similairly formatted .tsv file that cen be read and used by this program.
/////////////////////////////////////////////////////////////////////////////////////////
	...
	if (input) { //If we can open it continue with the program
		...
		do {
			...
			case 1: { //if 1 print the top 25 teams
				...
				cout << "Data saved in file " << fileName << " you can reopen that file with this program.\n\n"; //Tell the user what happened
				break;
		...
		} while (choice != 6 && choice != 7); //Do while loop condition. As long as the don't enter a 6 or 7 it will continue.
